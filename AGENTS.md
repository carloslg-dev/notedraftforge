...
Stack: Angular · IndexedDB · GitHub Pages.
...
- **DDD + Hexagonal**: `core/domain/` must have zero dependencies on Angular, IndexedDB, or any framework
- **No backend, no sync, no AI features** in MVP
- **Stack is fixed**: Angular · IndexedDB · GitHub Pages — no alternatives in MVP
