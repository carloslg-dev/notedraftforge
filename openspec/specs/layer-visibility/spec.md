...
- Visibility is controlled by CSS classes on the container — zero re-render on toggle.
...
**Available in:** both visualization and editing mode
**Behavior:**
...
**Trigger:** User opens a piece (visualization or editing mode)
**Behavior:**
...
- If no snapshot exists yet (new piece, never viewed): use default values from the table above

---

## Side Panel

- Always accessible from both modes
